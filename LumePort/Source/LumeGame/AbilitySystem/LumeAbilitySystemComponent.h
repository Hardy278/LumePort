...
#include "Abilities/LumeGameplayAbility.h"
...
public:
	...
	typedef TFunctionRef<bool(const ULumeGameplayAbility* LumeAbility, FGameplayAbilitySpecHandle Handle)> TShouldCancelAbilityFunc;
	...
	UE_API bool IsActivationGroupBlocked(ELumeAbilityActivationGroup Group) const;
	UE_API void AddAbilityToActivationGroup(ELumeAbilityActivationGroup Group, ULumeGameplayAbility* LumeAbility);
	UE_API void RemoveAbilityFromActivationGroup(ELumeAbilityActivationGroup Group, ULumeGameplayAbility* LumeAbility);
	UE_API void CancelActivationGroupAbilities(ELumeAbilityActivationGroup Group, ULumeGameplayAbility* IgnoreLumeAbility, bool bReplicateCancelAbility);
...
protected:
	...
	int32 ActivationGroupCounts[(uint8)ELumeAbilityActivationGroup::MAX];
};
