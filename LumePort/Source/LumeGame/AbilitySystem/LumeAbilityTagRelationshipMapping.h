...
#include "LumeAbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FLumeAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class ULumeAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FLumeAbilityTagRelationship> AbilityTagRelationships;
