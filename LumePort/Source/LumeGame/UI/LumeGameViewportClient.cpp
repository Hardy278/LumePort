...
#include "UI/LumeGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(LumeGameViewportClient)
...
ULumeGameViewportClient::ULumeGameViewportClient() :
	Super(FObjectInitializer::Get())
{
}

void ULumeGameViewportClient::Init(FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
