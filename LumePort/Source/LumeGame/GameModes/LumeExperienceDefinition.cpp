...
#include UE_INLINE_GENERATED_CPP_BY_NAME(LumeExperienceDefinition)

#define LOCTEXT_NAMESPACE "LumeSystem"

ULumeExperienceDefinition::ULumeExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult ULumeExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void ULumeExperienceDefinition::UpdateAssetBundleData()
{
